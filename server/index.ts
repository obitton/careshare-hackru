  ...
  try {
    ...
    const modePrompts: Record<string, string> = {
      ...
      VOLUNTEER_OUTBOUND: [
        ...
        'TOOL STRATEGY (DEFAULT → FALLBACK):',
        '- DEFAULT: Use Server HTTP tools first.',
        '    • logVolunteerCall (REQUIRED) → POST /api/agent/log-volunteer-call',
        '    • getVolunteer (optional) → GET /api/volunteer/:id',
        ...
        'STRICT ACTION POLICY:',
        '- You MUST record the result with logVolunteerCall before finishing; do not claim it unless the tool succeeds.',
